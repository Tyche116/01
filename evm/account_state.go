...
// GetCommittedState....
func (accSt *AccountState) GetCommittedState(addr common.Address, key common.Hash) common.Hash {
	// stateObject := accSt.getAccountObject(addr)
	// if stateObject != nil {
...
func (accSt *AccountState) ForEachStorage(common.Address, func(common.Hash, common.Hash) bool) error {
	return nil
}
...
func (accSt *AccountState) Commit() error {
	// 将bincode写入文件
	file, err := os.Create("./account_sate.db.json")
	if err != nil {
		return err
	}
...
func TryLoadFromDisk() (*AccountState, error) {
	file, err := os.Open("./account_sate.db.json")
